...
// ESP32-C3 每个 RMT 硬件内存块为 48 个 symbol，共 4 块。单通道独占全部
// 4 块以降低长帧发送期间的中断续填次数；双通道时每路各占 1 块。
#define STATUS_RMT_SINGLE_CHANNEL_MEMORY_SYMBOLS 192U
#define STATUS_RMT_DUAL_CHANNEL_MEMORY_SYMBOLS    48U
